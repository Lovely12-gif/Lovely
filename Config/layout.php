        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'Userindex.php' ? 'active' : ''; ?>">
              <a href="../View/Userindex.php">
                  <i class="fas fa-table"></i>
                  <p>User</p>
                </a>

                <li class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'Bookindex.php' ? 'active' : ''; ?>">
              <a href="../View/Bookindex.php">
                  <i class="fas fa-table"></i>
                  <p>Books</p>
                </a>
                </li>
                ...
                <div class="collapse" id="transaction">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="../View/Borrowindex.php">
                        <span class="sub-item">Borrowing</span>
                      </a>
                    </li>
                    <li>
                      <a href="../View/Returnindex.php">
                        <span class="sub-item">Returning</span>
                      </a>
                    </li>
                  </ul>
                </div>
